...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--generate-email", action="store_true", help="generate one mailbox local-part; currently intended for --email-type frimail/icloud")
    ...
    run.add_argument("--email-type", choices=["auto", "icloud", "frimail"], default="auto", help="mailbox type; frimail accepts local-part input and appends @cudaflowers.edu.kg")
    run.add_argument("--email-code-provider", choices=["auto", "agiunx", "frimail"], default="auto")
